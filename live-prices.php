...
$dummyURL = "http://partners.api.skyscanner.net/apiservices/pricing/uk1/v1.0/" . $session_key;

//echo $dummyURL;

get_live_prices($dummyURL);


function get_live_prices($sessionURL) {

  // 1. Query
  $session_url = $sessionURL . "?apiKey=de995438234178656329029769192274";
  //echo $session_url;
